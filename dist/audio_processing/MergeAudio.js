...
exports.processing = exports.MergeAudioStatus = void 0;
const crunker_1 = __importDefault(require("crunker"));
...
const processing = async (data) => {
    ...
    //MergeAudioStatus = "preparing download";
    try {
        let merger = new crunker_1.default();
    ...
    exports.MergeAudioStatus = "download ready";
};
